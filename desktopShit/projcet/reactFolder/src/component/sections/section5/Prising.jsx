...
function Prising(props) {
    ...
    function PrisingSection2(props) {
        return (
            <div data-aos={props.animtion} data-aos-duration="1500" className="section2OfPrising">
    ...
    function PriseBox(props) {
        return (
            ...
            <div  data-aos={props.animate} data-aos-duration="1500"  className="PrisingContiner">
    ...
    return (
        <div>
            <h2 data-aos="flip-left" data-aos-duration="2000" className="MainWord">Prising for every Business at any stage</h2>
            ...
            <div className="priseContiner">
                ...
                <div className="priseing2Continer">
                    <h2 data-aos="flip-left" data-aos-duration="2000" className="mainWord2">Amazing Features</h2>
                    <div className="continersPrise">
                        <PrisingSection2 animtion = "fade-down" title="Support 24/7" prisingImg="imgs\prisingImgs\gem.svg" />
                        <PrisingSection2 animtion = "fade-down" title="User Friendly" prisingImg="imgs\prisingImgs\people.svg" />
                        <PrisingSection2 animtion = "fade-down" title="Notifications" prisingImg="imgs\prisingImgs\notification.svg" />
                        <PrisingSection2 animtion = "fade-up" title="Accesibility" prisingImg="imgs\prisingImgs\gear.svg" />
                        <PrisingSection2 animtion = "fade-up" title="Cost Control" prisingImg="imgs\prisingImgs\cash.svg" />
                        <PrisingSection2 animtion = "fade-up" title="Chat With Friends" prisingImg="imgs\prisingImgs\textMessage.svg" />
                    </div>
                </div>
            </div>
            ...
            <div className="prising3Continer">
                <div className="prising3">
                    <p data-aos="fade-down" data-aos-duration="3000"  className="prisingAdvice">“People who succeed in business aren't afraid to hear feedback from their customers - they actually thrive from it.”</p>
                    <h5 data-aos="fade-right" data-aos-duration="3000"  className="PrisingCharater">Johanna S. Richardson</h5>
                    <p data-aos="fade-up" data-aos-duration="3000"  className="blue">CEO Essentials</p>
                </div>
                <div className="testimonials-women">
                    <img data-aos="zoom-in" data-aos-duration="3000" src="https://demo.epic-webdesign.com/tf-smart/v1/images/testimonials-woman.jpg" class="width-100" alt="pic" />
                </div>
            </div>
        </div>
    )
