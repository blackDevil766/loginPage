            ...
            <div className="continer">
                ...
                <div className="continerFliud">
                    <section className="howItWorkpart1">
                        <div className="part1">
                            <h2  data-aos="fade-down" data-aos-duration="1500" className="HowItWorkTitle">How It Work.</h2>
                            <p className="HowItWorkDifind" data-aos="fade-down" data-aos-duration="1500">Quis autem velis ets reprehender net etid quiste netsum voluptate. Utise wisi enim minim veniam, quis etsad ets aspernatis netsum stationes nets qualitats.</p>
                        </div>

                        <div className="part2">

                            <div className="section1Part1">
                                <p data-aos="flip-left"  data-aos-duration="1000" className="freelance">LinkedIn</p>

                                <div className="SkillsStars">
                                    <img data-aos="zoom-out-up" data-aos-duration="1000" src="imgs\starsIcon\starFille.svg" alt="" />
                                    <img data-aos="zoom-out-up" data-aos-duration="1500" src="imgs\starsIcon\starFille.svg" alt="" />
                                    <img data-aos="zoom-out-up" data-aos-duration="2000" src="imgs\starsIcon\starFille.svg" alt="" />
                                    <img data-aos="zoom-out-up" data-aos-duration="2500" src="imgs\starsIcon\starFille.svg" alt="" />
                                    <img data-aos="zoom-out-up" data-aos-duration="3000" src="imgs\starsIcon\starFille.svg" alt="" />
                                </div>

                            </div>

                            <div className="section2Part2">
                                <p data-aos="flip-left"  data-aos-duration="1000" className="freelance">Upwork</p>
                                ...
                                <div className="SkillsStars">
                                    ...
                                    <img data-aos="zoom-out-up" data-aos-duration="2000" src="imgs\starsIcon\starFille.svg" alt="" />
                                    <img data-aos="zoom-out-up" data-aos-duration="1500" src="imgs\starsIcon\starFille.svg" alt="" />
                                    <img data-aos="zoom-out-up" data-aos-duration="1000"  src="imgs\starsIcon\halfStar.svg" alt="" />
                    ...
                    <section className="howItWorkpart2">
                        ...
                        <div data-aos="fade-down" data-aos-duration="3500" className="listContiner">
                        ...
                        <div data-aos="fade-down" data-aos-duration="3000" className="listContiner">
                            <h2  className="listTitle">
                        ...
                        <div data-aos="fade-down" data-aos-duration="2500" className="listContiner">
                            <h2  className="listTitle">
